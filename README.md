...
An example app of how RxFx can enable simpler building of Conversational UX apps (ala ChatGPT), and featuring streaming, cancelation, and activity awareness.

![](https://d2jksv3bi9fv68.cloudfront.net/converation-ux-rxfx-demo.gif)

## You Get UX Bugs If You Think UI-First and Not Effect-First
